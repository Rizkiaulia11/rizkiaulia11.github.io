...
<head>
  ...
  <title>Portfolio Rizki Aulia</title>
  <style>
    body {
      background: url('b6226175-2c21-4ffb-bf85-4b92e51c7541.png') no-repeat center center fixed;
...
<section id="skills" class="container my-5">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <h5>Software</h5>
      <ul>
        <li>Microsoft Office, SketchUp, Visual Studio Code</li>
        <li>Psim, AutoCad, Arduino IDE</li>
        <li>Visio, ETAP, LabView, Fritzing</li>
      </ul>
    </div>
    <div class="col-md-4">
      <h5>Sertifikat</h5>
