...
<header class="text-white text-center py-5">
  <img src="Pas Foto.jpg" alt="Foto Rizki Aulia" class="rounded mb-3 profile-img">
...
<div class="container my-5">
  ...
  <section id="contact" class="section-container">
    ...
    <p class="section-text"><strong>Email:</strong> <a href="mailto:11rizkiaulia@gmail.com" style="color: #0d6efd;">11rizkiaulia@gmail.com</a></p>
  ...
  <section id="feedback" class="section-container">
    ...
    <form action="https://formspree.io/f/xrbqlgvn" method="POST">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="name" name="nama" required placeholder="Masukkan nama Anda">
      </div>
      <div class="mb-3">
