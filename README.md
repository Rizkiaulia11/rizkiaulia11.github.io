...
<body>
  ...
  <header class="profile-header text-white text-center py-5 bg-primary">
    <!-- Partikel animasi -->
    <div class="particles" id="particles-js"></div>

    <!-- Foto Profil -->
    <img src="Pas Foto.jpg" alt="Foto Profil Rizki Aulia" class="profile-photo mb-3">
    <h1 class="fw-bold">Rizki Aulia</h1>
    <p>Teknisi Listrik & Robotika | Lulusan Teknik Elektro</p>
  </header>
